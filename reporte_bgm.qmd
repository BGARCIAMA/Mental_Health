...
### 1.1. Introducción
La depresión es un trastorno mental común que afecta a millones de personas en todo el mundo. Identificar y comprender los factores que contribuyen al riesgo de depresión es fundamental para desarrollar estrategias efectivas de prevención y tratamiento. El aprendizaje de máquina ofrece una oportunidad para analizar y predecir la depresión en adultos, utilizando datos recopilados de encuestas y cuestionarios.
